...
Project Overview
This project provides a data-driven solution for hospital administrators to monitor clinical and operational efficiency. It tracks critical metrics such as Bed Occupancy Rate (200.00%), Average Length of Stay (7.55 days), and Doctor Utilization (50.00%).
